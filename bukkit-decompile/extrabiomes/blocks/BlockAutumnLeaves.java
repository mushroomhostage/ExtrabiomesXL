...
public class BlockAutumnLeaves extends BlockTransparant implements IShearable, ITextureProvider
{
    ...
    public BlockAutumnLeaves(int var1)
    {
        super(var1, 3, Material.LEAVES, false);
        this.a(true);
        this.c(0.2F);
        this.f(1);
        this.a(g);
        ...
        TerrainGenManager.blockYellowAutumnLeaves = this;
        TerrainGenManager.blockPurpleAutumnLeaves = this;
        TerrainGenManager.blockOrangeAutumnLeaves = this;
        TerrainGenManager.blockBrownAutumnLeaves = this;
    ...
    {
        this.a(var1, var2, var3, var4, new ItemStack(this.getDropType(var5, var1.random, var6), 1, this.getDropData(var5)));
    }
    ...
    {
        return this.textureId + 2 * unmarkedMetadata(var2) + (this.a() ? 1 : 0);
    }
                    ...
                    for (var12 = -4; var12 <= 4; ++var12)
                    {
                        for (var13 = -4; var13 <= 4; ++var13)
                        {
                            for (var14 = -4; var14 <= 4; ++var14)
                            {
                                ...
                                if (Block.byId[var15] != null && Block.byId[var15].isWood(var1, var2 + var12, var3 + var13, var4 + var14))
                                {
                                    this.adjacentTreeBlocks[(var12 + 16) * 1024 + (var13 + 16) * 32 + var14 + 16] = 0;
                                }
                                else if (Block.byId[var15] != null && Block.byId[var15].isLeaves(var1, var2 + var12, var3 + var13, var4 + var14))
                                {
